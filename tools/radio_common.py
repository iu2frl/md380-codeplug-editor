...
ARTIFACTS_ROOT = REPO_ROOT / "artifacts" / "codeplug"
...
def ensure_artifact_dirs() -> None:
  for path in (
      ARTIFACTS_ROOT / "read",
      ARTIFACTS_ROOT / "edited",
      ARTIFACTS_ROOT / "backup",
  ):
...
def write_manifest(path: Path, source: str, fmt: str, target_address: str | None = None) -> Path:
